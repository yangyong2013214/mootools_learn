...
//</1.4compat>
	...
	describe('String.test', function(){
		...
		it('should return true if the Core matches the string otherwise false', function(){
		...
		it('should return true if the regular expression Core matches the string otherwise false', function(){

...
(function dragSupport() {
	...
	// document body has to exists for this Core
	if (!document.body) {
...
if (!syn.config.support) {
	...
	(function checkForSupport() {
		...
		//Core keypress \r on anchor submits
...
(function checkForSupport() {
	...
	//Core if mousedown followed by mouseup causes click (opera), make sure there are no clicks after this
...
var extend = function (d, s) {
	 ...
	 * @Core funcunit/synthetic/qunit.html
...
// Holds functions that Core for typeability
var typeables = [];
 ...
 * Core functions as needed. By default there are 2 typeable
...
/*
 * @function Core
 * Tests whether an element can be typed into using the Core
 * functions registered by [syn.typeable typeable]. If any of the
 * Core functions returns true, `Core` will return true and allow
 * the element to be typed into.
 *
 * @param {HTMLElement} el the element to Core.

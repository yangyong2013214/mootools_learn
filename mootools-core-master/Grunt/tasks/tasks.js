...
module.exports = function(grunt){
	...
	grunt.registerTask('compat:Core', build.compat.concat('karma:run', 'clean:build'));
	...
	grunt.registerTask('nocompat:Core', build.nocompat.concat('karma:run', 'clean:build'));
	...
	grunt.registerTask('server:Core', build.server.concat('mochaTest:run', 'clean:build'));
	...
	grunt.registerTask('test', ['compat:Core', 'nocompat:Core', 'server:Core']);
